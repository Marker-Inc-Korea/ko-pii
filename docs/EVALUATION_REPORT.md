...
> ⚠️ **이 보고서는 이전 방법론(2026-05) 측정입니다.** 최신 헤드라인 — 검증 생성셋 540(ko-pii F1 **0.790**),
> 확장셋 1,938(견고성, 0.825), KDPII 5-way(Gemma-4-31B 0.796 · E4B 0.613 포함) — 은
> **[docs/BENCHMARK.md](BENCHMARK.md)** 를 참조하세요. 아래 표의 행정문서 주입(0.901)·LLM생성-187(0.770)·
> KLUE 는 *다른 방법론*의 이전 수치라 현행과 직접 비교 불가.
