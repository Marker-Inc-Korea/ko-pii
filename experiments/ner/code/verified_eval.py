...
usage: verified_eval.py [model_dir]
"""
...
MODEL = sys.argv[1] if len(sys.argv) > 1 else "/data1/mk04/pii_ner/out/klue_all_slurm/final"
...
out = "/data1/mk04/pii_ner/out/verified_klue_all.json"
